<?php
/**
 * The Template for displaying Support Feature posts.
 */
get_header();
?>
<div class="layout-single" id="layout-support-page">
    ...
    <div class="border-page width-1800">
        <section class="first-page" id="single-page-feature">
        	<?php
                get_template_part( 'template-part/single-post/content', 'feature' );	
            ?>
        </section>
    </div>
</div>
