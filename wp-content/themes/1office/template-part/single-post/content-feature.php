<?php
    ...
    // Get Taxonomy Of This Post
    $taxonomy = get_the_terms(get_the_ID(),'feature');
...
<section class="breadcrumb">
    <ul>
        ...
        <li>
            <a href="<?php echo esc_url(home_url()) ?>/feature/<?php echo $slug_tax ?>">
                <?php echo $name_tax ?>
                <span>&rsaquo;</span>
            </a>
        </li>
                ...
                <?php
                    ...
                    <li>
                        <a href="<?php echo esc_url(home_url()) ?>/feature/<?php echo $feature->slug ?>" 
                            class="
                            <?php 
                                if ( $feature->slug === $slug_tax ) {
                                    echo "active";
                                }
                            ?>
                            ">
                            <span class="icon-square">
                                <?php if ( count($allPost) > 0 && $feature->term_id === $id_tax ) { ?>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo esc_url(home_url()); ?>/support_feature/<?php echo $post->post_name; ?>" class="sub-item 
                                        <?php
                                            if ( $post->post_name === $inforPost->post_name ) {
                                                echo "active";
                                            }
                                        ?>
                                    ">
